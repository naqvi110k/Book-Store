...
function Navbar() {
  ...
  return (
    <>
    <div  className={` max-w-screen-4xl mx-auto md:px-20 px-4  dark:bg-slate-900 dark:text-white fixed top-0 right-0 left-0 z-50 ${
      sticky ? " dark:bg-slate-800 dark:text-white sticky-navbar shadow-md bg-base-200  duration-300 transition-all ease-in-out":""
    }`}>
